<script lang="ts">
	...
	const skills = [
		...
		{ name: "Tailwind CSS", level: "Begginer" },
	...
	onMount(async () => {
		try {
			...
			error =
				"Failed to fetch repositories. Please check your GitHub username and try again.";
			console.error(err);
		} finally {
			isLoading = false;
		}
...
<svelte:head>
	...
	<meta
		name="description"
		content="Full-stack developer and designer crafting beautiful, functional digital experiences. Explore my portfolio of web projects."
	/>
</svelte:head>
...
<main class="bg-white dark:bg-slate-950">
	<!-- Hero Section -->
	<section
		class="relative overflow-hidden bg-gradient-to-b from-slate-50 dark:from-slate-900 to-white dark:to-slate-950 pt-20 pb-20 md:pt-32 md:pb-24"
	>
		<!-- Decorative elements -->
		<div
			class="absolute top-0 right-0 w-96 h-96 bg-indigo-100 dark:bg-indigo-900/20 rounded-full blur-3xl -mr-48 -mt-48 opacity-50"
		/>
		<div
			class="absolute bottom-0 left-0 w-96 h-96 bg-emerald-100 dark:bg-emerald-900/20 rounded-full blur-3xl -ml-48 -mb-48 opacity-50"
		/>
		...
		<div class="relative max-w-7xl mx-auto px-4 md:px-6">
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
				<div class="animate-fade-in">
					<p
						class="text-indigo-600 dark:text-indigo-400 font-medium mb-4"
					>
						FULL STACK DEVELOPER & DESIGNER
					</p>
					<h1
						class="section-title mb-6 text-slate-900 dark:text-white"
					>
						Crafting Beautiful Digital Experiences
					</h1>
					<p class="section-subtitle mb-8">
						I design and develop modern web applications with a
						focus on elegant design, clean code, and exceptional
						user experiences.
					</p>
				...
				<div class="hidden lg:block animate-slide-up">
					<div
						class="glass rounded-xl p-6 border border-white/20 dark:border-slate-800/20"
					>
						<div class="space-y-4 font-mono text-sm">
							<div class="text-slate-400">
								{"<div"}
								<span class="text-emerald-500">class</span
								>="<span class="text-yellow-500">portfolio</span
								>"{">"}
							</div>
							<div class="ml-4 text-slate-400">
								{"<h1>"}<span class="text-pink-500"
									>Beautiful Code</span
								>{"</h1>"}
							</div>
							<div class="ml-4 text-slate-400">
								{"<p>"}<span class="text-cyan-500"
									>Pixel Perfect Design</span
								>{"</p>"}
							</div>
							<div class="ml-4 text-slate-400">
	...
	<!-- Skills Section -->
	<section
		class="py-20 md:py-28 bg-gradient-to-b from-white dark:from-slate-950 to-slate-50 dark:to-slate-900"
	>
				...
				{#each skills as skill, i}
					...
					>
						<div class="flex items-center gap-3 mb-3">
							<div
								class="w-3 h-3 rounded-full bg-gradient-to-r from-indigo-600 to-emerald-600"
							/>
							<h3
	...
	<section id="projects" class="py-20 md:py-28 bg-white dark:bg-slate-950">
		<div class="max-w-7xl mx-auto px-4 md:px-6">
			<div class="text-center mb-16 animate-fade-in">
				...
				<p class="section-subtitle max-w-2xl mx-auto">
					A selection of my recent work showcasing design and
			...
			<div
				class="glass rounded-xl border border-white/20 dark:border-slate-800/20 p-6 md:p-8 mb-16 animate-fade-in"
			>
				<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
					...
					<div class="md:col-span-2">
						<label
							for="search"
							class="block text-sm font-semibold mb-3 text-slate-900 dark:text-white"
						>
							Search Projects
						</label>
						<input
				...
				<p class="text-sm text-slate-600 dark:text-slate-400">
					Showing <span
						class="font-semibold text-slate-900 dark:text-white"
						>{filteredRepositories.length}</span
					>
					of
			...
			{:else if error}
				<div
					class="glass rounded-xl p-8 border border-red-200/30 dark:border-red-900/30 text-center max-w-2xl mx-auto"
				>
					<p
						class="text-red-600 dark:text-red-400 font-semibold mb-2"
					>
	...
	<section
		id="about"
		class="py-20 md:py-28 bg-gradient-to-b from-slate-50 dark:from-slate-900 to-white dark:to-slate-950"
	>
		<div class="max-w-7xl mx-auto px-4 md:px-6">
			<div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
				<div class="animate-fade-in">
					...
					<div
						class="space-y-4 text-slate-600 dark:text-slate-400 text-lg leading-relaxed"
					>
						<p>
							...
							technologies and a keen eye for design, I transform
							ideas into elegant, functional solutions.
						</p>
						<p>
							My approach combines clean code architecture with
							thoughtful UI/UX design, ensuring that every project
							is both beautiful and performant. I thrive on
							solving complex problems and constantly learning new
							technologies.
						</p>
						<p>
							When I'm not coding, you can find me exploring new
							design trends, contributing to open source, or
				...
				<div
					class="glass rounded-xl p-8 border border-white/20 dark:border-slate-800/20 animate-slide-up"
				>
					<h3
					...
					<div class="space-y-4">
						<div class="flex items-start gap-4">
							...
							<div>
								<h4
									class="font-semibold text-slate-900 dark:text-white mb-1"
								>
									Focused
								</h4>
								<p
								...
								>
									On creating user-centric solutions
								</p>
							</div>
						</div>
						<div class="flex items-start gap-4">
						...
						<div class="flex items-start gap-4">
							...
							<div>
								...
								<p
									class="text-sm text-slate-600 dark:text-slate-400"
								>
									Brings design thinking to development
								</p>
							</div>
						</div>
						<div class="flex items-start gap-4">
	...
	<section
		id="contact"
		class="py-20 md:py-28 bg-gradient-to-r from-indigo-600 to-emerald-600"
	>
		<div class="max-w-4xl mx-auto px-4 md:px-6 text-center animate-fade-in">
			<h2
				class="text-4xl md:text-5xl font-bold text-white mb-6 font-display"
			>
